...
question = sys.argv[1]
output_file_8 = "combined_outputs.txt"

# Ensure the common output file is empty at the start
with open(output_file_8, "w") as f:
	f.write("")
...
#SBATCH --job-name=firstq_{role}_{temperature}_{i}
...
python testfall2022.py "{question}" {role} {temperature} {i} >> output_file_8"""
